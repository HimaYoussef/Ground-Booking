  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: false,
        title: Text(
           S.of(context).Edit_profile_head,
          style: getTitleStyle(
              fontSize: 20,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText: S.of(context).Edit_profile_Your_name,
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText:  S.of(context).Edit_profile_Current_password,
                        hintStyle: getbodyStyle(color: Colors.grey),
                        fillColor: AppColors.white,
                        filled: true,
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType.visiblePassword,
                      decoration: InputDecoration(
                        hintText: S.of(context).Edit_profile_New_Password,
                        hintStyle: getbodyStyle(color: Colors.grey),
                        fillColor: AppColors.white,
                        filled: true,
                        suffixIcon: IconButton(
                      ...
                      child: Container(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(
                               S.of(context).Edit_profile_save_change_button,

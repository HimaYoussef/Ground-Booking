    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          title:  Text(S.of(context).Last_order_Dialog_title),
          content:
               Text(S.of(context).Last_order_Dialog_content),
          actions: [
            cancelButton,
            continueButton,
          ],
                                              ...
                                              Column(
                                                children: [
                                                  Row(
                                                    children: [
                                                      Text(
                                                        S.of(context).Last_order_Last_book,
                                                        style: getsmallStyle(
                                                            color:
                                                                AppColors.black,
                                                            fontWeight:
                                                  ...
                                                  Row(
                                                    children: [
                                                      TextButton(
                                                        ...
                                                        child: Text(
                                                          S.of(context).Last_order_Comment_and_rate,
                                                          style: getsmallStyle(
                                                              fontSize: 10,
                                                              color: AppColors
                                                                  .color2),
                                                      ...
                                                      TextButton(
                                                          ...
                                                          child: Text(
                                                           S.of(context).Last_order_Cancel_button,
                                                            style: getsmallStyle(
                                                                color: AppColors
                                                                    .color2),
                                                          ))

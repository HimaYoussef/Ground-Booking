...
import 'package:pitch_test/features/customer/Home/Booking_court.dart';
import 'package:pitch_test/features/customer/Home/Widgets/Review.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        title: Text(
          S.of(context).Details_View_Head,
          style: getTitleStyle(
              fontSize: 20,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(
                                 S.of(context).Details_View_desc,
                                style: getTitleStyle(
                                  fontSize: 10,
                                  color: AppColors.color1,
                                ),
                              ...
                              TextButton(
                                ...
                                child: Text(
                                  S.of(context).Details_View_Review,
                                  style: getTitleStyle(
                                    fontSize: 10,
                                    color: AppColors.color1,
                                  ),
                            ...
                            child: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: Text(
                                     S.of(context).Details_View_Booking_button,
